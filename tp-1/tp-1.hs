...
superaA (ConstPokemon Agua   _)  (ConstPokemon Fuego  _)  = True
superaA (ConstPokemon Fuego  _)  (ConstPokemon Planta _)  = True
superaA (ConstPokemon Planta _)  (ConstPokemon Agua   _)  = True
superaA (ConstPokemon _      _)  (ConstPokemon _      _ ) = False
--
cantidadDePokemonDe :: TipoDePokemon -> Entrenador -> Int
cantidadDePokemonDe tp (ConstEntr _ pok1 pok2 ) = cantidadDe  tp pok1  +cantidadDe  tp pok2
cantidadDe:: TipoDePokemon -> Pokemon -> Int
cantidadDe Agua   (ConstPokemon Agua   _) = 1
cantidadDe Fuego  (ConstPokemon Fuego  _) = 1
cantidadDe Planta (ConstPokemon Planta _) = 1
cantidadDe _      (ConstPokemon _      _) = 0
--
